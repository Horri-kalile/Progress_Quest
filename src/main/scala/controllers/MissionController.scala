...
object MissionController:
  ...
  /** Generates a new random mission for the given player.
    ...
    *
    * @param player
    *   the player for whom the mission is generated
    * @return
    *   a new randomized [[Mission]] instance
    */
  ...
  /** Adds a mission to the player's mission list.
    ...
    *
    * @param player
    *   the player receiving the mission
    * @param mission
    *   the mission to add
    * @return
    *   updated [[Player]] instance with the mission added
    */
  ...
  /** Progresses a mission for the player and checks for completion.
    *
    * If the mission becomes completed after progression, rewards (gold, XP, optional item) are granted. The completed
    * mission is then removed from the mission list.
    *
    * @param player
    *   the player progressing a mission
    * @param m
    *   the mission to progress
    * @return
    *   updated [[Player]] instance with mission progress and possible rewards applied
    */
