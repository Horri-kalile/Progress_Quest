...
object Behavior:
  ...
  /** Trait defining a behavior strategy. Override the relevant hooks to alter player mechanics during gameplay.
    */
  trait Strategy:
  ...
  /** DexterityBoost: Increases the player's dexterity attribute by a random amount at game start. This boost affects
    * dodge chance during battle.
    */
  ...
  /** OneShotChance: Grants a 25% chance to instantly defeat an enemy by dealing massive damage. If triggered, damage =
    * 99 × player level; otherwise normal damage applies.
    */
