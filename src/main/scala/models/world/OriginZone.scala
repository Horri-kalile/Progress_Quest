 ...
 *
 * OriginZone defines the different biomes and regions within the game world where
 * specific types of monsters naturally spawn. Each zone has distinct environmental
 * characteristics that influence monster types, behaviors, and combat modifiers.
 *
 * Zones are used by:
